...
function say_name(num){
	...
	switch(num){
		case 0:
			this.alTextToSpeech.say(value+"三っ！");
			break;
		case 1:
			this.alTextToSpeech.say(value+"三の");
			break;
		case 2:
			this.alTextToSpeech.say(value+"三は");
			break;
	}
...
function name_saying(num){
	...
	switch(num){
		case 1:
			self.alTextToSpeech.say("そんな素敵な" +value+"三だからこそ、お話しいただいた、体験ができたんですねッ！");
			break;
		case 2:
			self.alTextToSpeech.say("謙虚なとこ炉が、" +value+"三の、良いとこ炉ですね！");
			break;
		case 3:
			self.alTextToSpeech.say("人に感謝を、忘れないとこ炉が、" +value+"三の、良いとこ炉ですねッ！");
			break;
		case 4:
			self.alTextToSpeech.say("それでも頑張った" +value+"三は、素晴らしいと思います");
			break;
		case 5:
			self.alTextToSpeech.say(value+"三の、ご兄弟や、ご家族についても、教えて下さい！");
			break;
		case 6:
			self.alTextToSpeech.say("改めまして、"+value+"三、僕の住む、大岡山へようこそ！");
			break;
		case 7:
			self.alTextToSpeech.say(value+"三の、最近あった、楽しかったことも、知りたいです！");
			break;
		case 8:
			self.alTextToSpeech.say("僕は寒さが苦手だから、春になったら、"+value+"三の、故郷に胃ってみたいなーッっ！");
			break;
	}
}
